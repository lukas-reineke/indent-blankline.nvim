...
Some plugins define colorscheme for RainbowDelimiters, so you can reuse the same colors for indent-blankline as well.
...
require("ibl").setup { indent = { highlight = highlight } }
-- or if you want to use colorscheme just for scope:
